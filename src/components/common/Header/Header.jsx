...
//           {/* Right Social + Profile/Login */}
//           <div className="d-flex align-items-center">
//             <a href="#" className="text-white mx-2"><FaFacebookF size={16} /></a>
//             <a href="#" className="text-white mx-2"><FaXTwitter size={16} /></a>
//             <a href="#" className="text-white mx-2"><FaYoutube size={16} /></a>
//             <a href="#" className="text-white mx-2"><FaInstagram size={16} /></a>
    ...
    <>
      ...
      >
        <Container fluid className="d-flex justify-content-between align-items-center py-1 px-3">
          ...
          {/* Right Social + Profile/Login */}
          <div className="d-flex align-items-center">
            {/* Social Icons - Hidden on small screens, shown on medium and up */}
